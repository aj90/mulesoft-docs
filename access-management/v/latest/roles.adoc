...
[NOTE]
--
Access to Support Portal: If only have the Portal viewer and/or the Exchange Viewer role, you will not  have access to the organization's support portal. This also applies to accounts where the only permission associated it is Portal Viewer and/or Application Owner.
--
